...
Route::post('/ulasan/simpan', [PeminjamanController::class, 'simpanUlasan'])->name('ulasan.simpan');
 Route::post('/admin/balas-ulasan/{id}', [PeminjamanController::class, 'balasUlasan'])->name('admin.balas.ulasan');
...
Route::post('/balas-ulasan/{id}', [PeminjamanController::class, 'balasUlasan'])->name('admin.balas.ulasan'); 
